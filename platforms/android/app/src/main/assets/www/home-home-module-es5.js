      ...
      var HomePage = /*#__PURE__*/function () {
        ...
        _createClass(HomePage, [{
          ...
          value: function schedule() {
            ...
            for (var i = 0; i < this.numOfNotifications; i++) {
              var id = i + 1;
              var time = new Date(now + id * this.intervalInMinutes * 60000);
              notifications.push({
                id: id,
                title: "Test ".concat(id),
                text: "Expected at ".concat(time.toLocaleString()),
                foreground: true,
                trigger: {
                  at: time
                },
              ...
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      _context.next = 2;
                      return this.localNotification.cancelAll();
